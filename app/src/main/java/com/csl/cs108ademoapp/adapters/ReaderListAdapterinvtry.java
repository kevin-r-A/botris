...
public class ReaderListAdapterinvtry extends ArrayAdapter<ReaderDevice> {
    private final Context context;
    private final int resourceId;
    private final ArrayList<ReaderDevice> readersList;
    private final boolean select4detail;

    public ReaderListAdapterinvtry(Context context, int resourceId, ArrayList<ReaderDevice> readersList, boolean select4detail) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView checkedTextView = convertView.findViewById(R.id.reader_checkedtextview);
        String text1 = "";
        ...
        if (reader.getAddress() != null) {
            if (reader.getAddress().length() != 0) {
                ...
                text1 += reader.getAddress().substring(0,12);
            }
        }
