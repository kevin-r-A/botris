...
public class InventoryBarcodeFragment extends CommonFragment {
    ...
    void startStopHandler(boolean buttonTrigger) {
        ...
        if (started == false) {
            ...
            started = true;
            inventoryBarcodeTask = new InventoryBarcodeTask(MainActivity.sharedObjects.barsList, readerListAdapter, null, barcodeRunTime, barcodeVoltageLevel, barcodeYieldView, button, null, barcodeTotal, false, null);
