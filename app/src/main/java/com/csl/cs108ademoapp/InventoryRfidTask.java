...
public class InventoryRfidTask extends AsyncTask<Void, String, String> {
    final boolean DEBUG = false; final boolean ALLOW_WEDGE = true;
    private MutableLiveData<ReaderDevice> readerDeviceLiveData;
    ...
    protected void onPreExecute() {
        ...
        if (button != null) button.setText("DETENER");
...
//                                    saveExternalTask.openServer();
 ...
 //                                   saveExternalTask.closeServer();
                            ...
                            //MainActivity.mCs108Library4a.appendToLogView("Value RFID: " + readerDevice.getAddress());
                            //MainActivity.mCs108Library4a.appendToLog("Value RFID: " + readerDevice.getAddress());
                            if (this.readerDeviceLiveData != null) this.readerDeviceLiveData.setValue(readerDevice);
                        }
            ...
            if (invalidDisplay) {
                ...
                String stringTemp = String.valueOf(yield); //Total inventario
                if (true) {
                ...
                if (total != 0) {
                    ...
                    String strRate = "Totalaa:" + String.valueOf(allTotal) + "\n";
                    if (lastTime == 0) {
    ...
    public InventoryRfidTask(Context context, int extra1Bank, int extra2Bank, int data1_count, int data2_count, int data1_offset, int data2_offset,
                             ...
                             ArrayList<ReaderDevice> tagsList, ReaderListAdapterinvtry readerListAdapter, TextView geigerTagRssiView,
                             String strExtra1Filter, String strExtra1Decode,
                             TextView rfidRunTime, TextView geigerTagGotView, TextView rfidVoltageLevel,
                             TextView rfidYieldView, Button button, TextView rfidRateView, MutableLiveData<ReaderDevice> readerDeviceLiveData) {
        ...
        this.readerDeviceLiveData = readerDeviceLiveData;
    ...
    void DeviceConnectTask4InventoryEnding(TaskCancelRReason taskCancelRReason) {
        ...
        if (button != null) button.setText("INICIAR"); MainActivity.sharedObjects.runningInventoryRfidTask = false;
